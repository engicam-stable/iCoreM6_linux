...
#define MX6DL_SD3_CMD_PAD_CTRL (PAD_CTL_PKE | PAD_CTL_PUE |    \
		PAD_CTL_PUS_100K_UP)

#define MX6DL_ENET_TXD1_PAD_CTRL (PAD_CTL_PKE | PAD_CTL_PUE |    \
		PAD_CTL_PUS_100K_UP)
...
#define MX6DL_PAD_ENET_TXD1__GPIO_1_29                                         \
		IOMUX_PAD(0x05D8, 0x0208, 5, 0x0000, 0, MX6DL_ENET_TXD1_PAD_CTRL)
...
#define MX6DL_PAD_SD3_CMD__GPIO_7_2                                            \
		IOMUX_PAD(0x06F8, 0x0310, 5, 0x0000, 0, MX6DL_SD3_CMD_PAD_CTRL)
